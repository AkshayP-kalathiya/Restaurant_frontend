...
const Home_usa_payment_edit = ({ item }) => {
    // create family
    ...
    const handleShow20 = () => {
        ...
        setTimeout(() => {
            ...
            navigate('/home/usa/information', { replace: true });
                ...
                <div className="d-flex">
                    ...
                    <div className=" flex-grow-1 sidebar overflow-hidden">
                        <div className="p-3 m_bgblack text-white  ">
                            <Link to="/home/usa/information" className='d-flex text-decoration-none' >
...
export default Home_usa_payment_edit;
