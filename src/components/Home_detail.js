                ...
                <div className='flex-grow-1 sidebar overflow-y-scroll ' style={{ backgroundColor: "#1F2A37" }}>
                    ...
                    <Tabs
                        ...
                        <Tab eventKey="profile" title="Información" style={{ backgroundColor: "#1F2A37" }} className='py-2 mt-2'>
                            ...
                            <div>
                                <form action="">
                                    <div className='gap-5 b_inputt flex-grow-1 j_hd_inputs' >
                                        <div className=' b_search text-white a_input_size j_hd_input_last'>
                            ...
                            <div>
                                <div className='j_hd_inputs gap-5  b_inputt  '>
                                    <div className=' b_search text-white a_input_size j_hd_input_last' >
