                ...
                <div className='flex-grow-1 sidebar' style={{ backgroundColor: "#1F2A37", }}>
                    <div style={{ padding: "20px" }}>
                        ...
                        <div className="j_u_flex_jcsb">
                            ...
                            <div className='j_u_right'>
                                <button
                                    className="btn text-white j-btn-primary text-nowrap m12 j_u_btn_primary"
                                    onClick={handleShow}
                                >
                                    <FaPlus /> Invitar
                                </button>
                                ...
                                <Modal
                                    ...
                                    keyboard={false}
                                    className="m_modal j_user_modal"
                                >
                                    ...
                                    <Modal.Body className="border-0 pb-0">
                                        <div>
                                            <div className="j_modal_last_final">
                                                <div class="j_user_pass_margin">
                                                ...
                                                <div class="j_u_select">
                                                    <label className='mb-2'>Rol</label>
                                                    <div className="">
                                                        <select className='jm_input j_user_input'>
                                            ...
                                            <div className="j_user_d_flex mt-2">
                                                <div className="j_user_pass_margin">
                                                    <label
                                                        htmlFor="password"
                                                    ...
                                                    <div className="icon-input j_u_icon_input">
