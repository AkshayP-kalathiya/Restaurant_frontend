    ...
    <div className="m_bg_black">
      ...
      <div className="d-flex">
        ...
        <div className=" flex-grow-1 sidebar">
          ...
          <div className="row ">
            <div className="col-sm-2 col-4 m_bgblack   m-0 p-0  m_borrig j_article_height">
              ...
              <div className="p-3 m_bgblack pb-1  text-white d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div className="d-flex gap-4">
                  ...
                  <Modal
                    ...
                    keyboard={false}
                    className="m_modal jm-modal_jjjj m1 jay_finalll"
                  >
                    <Modal.Header
                      closeButton
                      className="m_borbot"
                          ...
                          <div className="p-3 text-white  flex-wrap">
                            ...
                            <div>
                              <div className="j_pc_center">
                                ...
                                <div>
                                  <Button
                                    className="mgreenbtn pt-2  m14 border-0 text-nowrap j_this_margin"
                                    onClick={() => {
                                      handleClose1Prod();
                                      handleShow1AddSuc();
                                    }}
