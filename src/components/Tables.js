...
const Tables = () => {
  ...
  const handleCloseOcupadoModal = () => { setShowOcupadoModal(false); setIsEditing(false) };
      ...
      <div className="d-flex">
        ...
        <div className=" flex-grow-1 sidebar">
          ...
          <div className="row ">
            ...
            <div style={{ flexGrow: "1" }} className=" col-9 j-card-width2 j-table-position-second m-0 p-0">
                ...
                <div className="j-counter-price-data">
                  ...
                  <div className="j-counter-order">
                        ...
                        <div className="j-counter-order-border-fast j-counter-order-border-fast-margin" key={index}>
                          <div className="j-counter-order-img">
                            <div className="j_inquary_data">
                              ...
                              <h5 className="text-white mb-0 j-tbl-font-5">{item.name}</h5>
                            </div>
                    ...
                    <div className="j-counter-total-2">
                      ...
                      <div onClick={handleEditSave} className="btn w-100 j-btn-primary text-white j-tbl-btn-font-1">Cobrar</div>
                    </div>
                  </div>
                </div>
                <Modal
