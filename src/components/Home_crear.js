                                                ...
                                                <div className="p-3 m_bgblack text-white m-3 p-3 me-2">
                                                    ...
                                                    <Tab.Pane eventKey="productos">
                                                        {navactiveTab === 'productos' && (
                                                            <div className='a_deli_infolist p-4 mt-5 mx-2 mb-3' >
                                                                {
                                                                ...
                                                                <Accordion.Item eventKey="0" className="mb-2">
                                                                    <Accordion.Header>
                                                                        <div
                                                                            ...
                                                                            className={`sj_bg_border j_hc_accordion_padding  sj_w-75 ${selectedCheckbox === "1" ? "active" : ""}`}
                                                                        >
                                                                            <input
                                                                                type="checkbox"
                                                                                name="receiptType"
                                                                            ...
                                                                            />
                                                                            <p className="d-inline caja-pajo-title">Usar para futura compra</p>
                                                                        </div>
                                                                    </Accordion.Header>
                                                                </Accordion.Item>
                                                                <Accordion.Item eventKey="1" className="mb-2">
                                                                    <Accordion.Header>
                                                                        <div
                                                                            ...
                                                                            className={`sj_bg_border j_hc_accordion_padding  sj_w-75 ${selectedCheckbox === "2" ? "active" : ""}`}
                                                                        >
                                                                            <input
                                                                                type="checkbox"
                                                                                name="receiptType"
                                                                                ...
                                                                                className="me-2 j-change-checkbox"
                                                                            />
                                                                            <p className="d-inline caja-pajo-title">Pago de caja</p>
                                                                        </div>
                                                                    </Accordion.Header>
                                                                    <Accordion.Body>
                                                                        <div className='mx-0 b_bborder m-3 p-3'>
                                                                            <div
                                                                                className={`sj_bg_border j_hc_d_flex sj_w-75`}
                                                                            >
                                                                                <div className='me-3'>
                                                                                    <input
                                                                                        type="radio"
                                                    ...
                                                    {navactiveTab === 'productos' && (
                                                        <div className="p-3 m_bgblack text-white m-3">
                                                            ...
                                                            <div className="deli_infolist p-2">
                                                                ...
                                                                <div className="j_hc_flex">
                                                                    <div className="j_hc_div_width">
                                                                        <div>DNI</div>
                                                                        <div className="j_hc_width a_bg_order border-0 mt-2" style={{ borderRadius: "10px" }}><span className="">{order1}</span></div>
                                                                    </div>
                                                                    <div className="j_hc_div_width j_this_for">
                                                                        <div>Correo electrónico</div>
                                                                        <div className="j_hc_width a_bg_order border-0 mt-2" style={{ borderRadius: "10px" }}><span className="">{email}</span></div>
                                                                    </div>
                                                                </div>
                                                                <div className="mt-4">
                                                                    <h5>Productos</h5>
