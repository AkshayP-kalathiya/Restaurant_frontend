        ...
        <>
            ...
            <div className="s_bg_dark">
                <div className="j-flex">
                        ...
                        <div className=" mt-2 mx-2 sj_hwidth">
                            <div className="bg_gay p-4">
                                <div className="j-final-stage">
                                    ...
                                    <button className="sj_bg_sky j_bg_sky" onClick={handleShow}><FaPlus className="j-icon-font-1" />
                    ...
                    <div className="j-counter-price bg_gay bg_margin position-sticky" style={{ top: '77px' }}>
                            ...
                            <div className="j-counter-price-data">
                                ...
                                <div className="j-orders-inputs j_inputs_block">
                                    <div className="j-orders-code">
                                        ...
                                        <input className="j-input-name j_input_name2" type="text" placeholder="01234" />
                                    </div>
                                    <div className="j-orders-type me-2">
                                        <label className="j-label-name  text-white mb-2 j-tbl-font-6 ">
                                            Tipo pedido
                                        </label>
                                        <select className="form-select j-input-name-2 j-input-name-23">
