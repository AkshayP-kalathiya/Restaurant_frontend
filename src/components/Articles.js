...
export default function Articles() {
  ...
  const [showEditSubFamDel2, setShowEditSubFamDel2] = useState(false);
  const handleCloseEditSubFamDel2 = () => setShowEditSubFamDel2(false);
  const handleShowEditSubFamDel2 = () => setShowEditSubFamDel2(true);
    ...
    <div className="m_bg_black">
      ...
      <div className="d-flex">
        ...
        <div className=" flex-grow-1 sidebar">
          ...
          <div className="row ">
            <div className="col-sm-2 col-4 m_bgblack m-0 p-0 b_bring j_article_height" >
            ...
            >
              ...
              <Modal.Body>
                <div className="text-center">
                  ...
                  <p className="mb-0 mt-2 h6">Familia</p>
                  <p className="opacity-75">
                    Ha sido eliminada correctamentedsfgfghfgj21111111111111111111111111113
                  </p>
                </div>
              </Modal.Body>
            </Modal>
            ...
            <Modal
              show={showEditSubFamDel2}
              onHide={handleCloseEditSubFamDel2}
              backdrop={true}
              keyboard={false}
              className="m_modal jay-modal"
            >
